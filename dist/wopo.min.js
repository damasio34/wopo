!function(o){"use strict";o.module("wopo.services",[]),o.module("wopo",["wopo.services"])}(angular);
!function(n){var o=n.module("wopo");o.provider("wopoProvider",function(){var n,o;return{setAppId:function(o){n=o},setRestApiKey:function(n){o=n},$get:function(){return{APP_ID:n,REST_API_KEY:o}}}})}(angular);
